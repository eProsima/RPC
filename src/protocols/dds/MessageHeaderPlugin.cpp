...
DDS_TypeCode* SampleIdentityPlugin::get_typecode()
{
    ...
    if (!is_initialized)
    {
        ...
        SampleIdentity_g_tc_members[1]._representation._typeCode =
                (RTICdrTypeCode*)SequenceNumber_tPlugin::get_typecode();
...
DDS_TypeCode* rpc::RequestHeaderPlugin::get_typecode()
{
    ...
    if (!is_initialized)
    {
        ...
        RequestHeader_g_tc_members[1]._representation._typeCode =
                (RTICdrTypeCode*)&RequestHeader_g_tc_instanceName_string;
...
DDS_TypeCode* rpc::ReplyHeaderPlugin::get_typecode()
{
    ...
    if (!is_initialized)
    {
        ...
        ReplyHeader_g_tc_members[1]._representation._typeCode =
                (RTICdrTypeCode*)rpc::RemoteExceptionCode_tPlugin::get_typecode();
