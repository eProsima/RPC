...
$(DDSRPC_TARGET_DEBUG): $(DDSRPC_OBJS_DEBUG)
	$(LN) $(LDFLAGS) -shared -o $(DDSRPC_TARGET_DEBUG) $(LIBRARY_PATH) $(LIBS_DEBUG) $(DDSRPC_OBJS_DEBUG)
...
$(DDSRPC_TARGET): $(DDSRPC_OBJS_RELEASE)
	$(LN) $(LDFLAGS) -shared -o $(DDSRPC_TARGET) $(LIBRARY_PATH) $(LIBS) $(DDSRPC_OBJS_RELEASE)
