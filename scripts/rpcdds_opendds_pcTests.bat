...
"%JAVA_HOME%\bin\java" -DPATH="%PATH%" -DTAO_ROOT="%TAO_ROOT%" -DDDS_ROOT="%DDS_ROOT%" -DRPCDDSHOME="%RPCDDSHOME%" -Djava.ext.dirs="%RPCDDSHOME%\rpcddsgen\lib" com.eprosima.rpcdds.RPCDDSGEN -middleware opendds %args% "-I%RPCDDSHOME%/idl"
