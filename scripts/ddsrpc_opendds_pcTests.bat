...
"%JAVA_HOME%\bin\java" -DPATH="%PATH%" -DTAO_ROOT="%TAO_ROOT%" -DDDS_ROOT="%DDS_ROOT%" -Djava.ext.dirs="..\..\..\..\idl2ddsrpc\lib" com.eprosima.ddsrpc.idl.IDL2DDSRPC -middleware opendds %args%
