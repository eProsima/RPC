...
namespace FooInterface
{
     ...
     */
    class FooResource_FooProcedureCallbackHandler
    {
        public:
            /*!
    ...
    /*!
     * @brief This class implements a specific server's proxy for the defined interface FooResource.
     */
    class RPCDDSUSERDllExport FooResourceProxy : public eprosima::rpcdds::proxy::Proxy
    {
        public:
             ...
             */
            FooResourceProxy(eprosima::rpcdds::transport::ProxyTransport &transport,
            ...
            void FooProcedure_async(FooResource_FooProcedureCallbackHandler &obj);
