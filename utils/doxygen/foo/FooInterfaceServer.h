 ...
 * This header file contains the declaration of the server for interface FooInterface.
 *
...
class FooInterfaceServer : public eProsima::RPCDDS::Server
{
    public:
         ...
         */
        FooInterfaceServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \exception eProsima::RPCDDS::InitializeException This exception is thrown when the initialization was wrong.
         */
        FooInterfaceServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy, eProsima::RPCDDS::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~FooInterfaceServer();

        static void FooProcedure(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
