...
class FooInterfaceServer : public eProsima::DDSRPC::Server
{
    public:
         ...
         */
        FooInterfaceServer(eProsima::DDSRPC::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \param domainId The DDS domain that DDS will use to work. Default value: 0
         */
        FooInterfaceServer(eProsima::DDSRPC::ServerStrategy *strategy, eProsima::DDSRPC::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~FooInterfaceServer();

        static void foo_procedure(eProsima::DDSRPC::Server *server, void *requestData, eProsima::DDSRPC::ServerRPC *service);
