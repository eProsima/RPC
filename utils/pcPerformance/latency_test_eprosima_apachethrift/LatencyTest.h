...
class LatencyTestIf {
 public:
  ...
  virtual void latency(st& _return, const st& param) = 0;
};
...
class LatencyTest_latency_result {
 public:
  ...
  void __set_success(const st& val) {
    success = val;
  }
...
class LatencyTestClient : virtual public LatencyTestIf {
 public:
  ...
  void latency(st& _return, const st& param);
  void send_latency(const st& param);
  void recv_latency(st& _return);
 protected:
