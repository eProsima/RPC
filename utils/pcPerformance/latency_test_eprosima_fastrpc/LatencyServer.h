...
/*!
 * @brief This class implements a specific server for the defined interface Latency by user.
 * @ingroup LATENCY
 */
class FASTRPCUSERDllExport LatencyServer : public eprosima::rpc::server::Server
{
    public:
         ...
         */
        LatencyServer(eprosima::rpc::strategy::ServerStrategy &strategy, eprosima::rpc::transport::ServerTransport &transport,
            eprosima::rpc::protocol::LatencyProtocol &protocol, LatencyServerImpl &servant);

        //! @brief Destructor.
        virtual ~LatencyServer();

        
     private:
        
        //! \brief Pointer to the server's servant implemented by the user.
        LatencyServerImpl &_impl;
};


#endif // _LatencySERVER_H_