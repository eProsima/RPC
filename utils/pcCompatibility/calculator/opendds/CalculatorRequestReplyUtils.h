...
class Calculator_additionRequestUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_additionRequest& instance, /*in*/ CORBA::Long x, /*in*/ CORBA::Long y);
         ...
         */
        static void extractTypeData(Calculator_additionRequest& data, /*in*/ CORBA::Long& x, /*in*/ CORBA::Long& y);
};
...
class Calculator_additionReplyUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_additionReply& instance, /*out*/ CORBA::Long addition_ret);
...
* \param retcode Internal message returned from the server.
         */
        static void extractTypeData(Calculator_additionReply& data, eProsima::RPCDDS::ReturnMessage& retcode, /*out*/ CORBA::Long& addition_ret);
};
...
class Calculator_substractionRequestUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_substractionRequest& instance, /*in*/ CORBA::Long x, /*in*/ CORBA::Long y);
         ...
         */
        static void extractTypeData(Calculator_substractionRequest& data, /*in*/ CORBA::Long& x, /*in*/ CORBA::Long& y);
};
...
class Calculator_substractionReplyUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_substractionReply& instance, /*out*/ CORBA::Long substraction_ret);
...
* \param retcode Internal message returned from the server.
         */
        static void extractTypeData(Calculator_substractionReply& data, eProsima::RPCDDS::ReturnMessage& retcode, /*out*/ CORBA::Long& substraction_ret);
};
...
class Calculator_multiplicationRequestUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_multiplicationRequest& instance, /*in*/ CORBA::Long x, /*in*/ CORBA::Long y);
         ...
         */
        static void extractTypeData(Calculator_multiplicationRequest& data, /*in*/ CORBA::Long& x, /*in*/ CORBA::Long& y);
};
...
class Calculator_multiplicationReplyUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_multiplicationReply& instance, /*out*/ CORBA::Long multiplication_ret);
...
* \param retcode Internal message returned from the server.
         */
        static void extractTypeData(Calculator_multiplicationReply& data, eProsima::RPCDDS::ReturnMessage& retcode, /*out*/ CORBA::Long& multiplication_ret);
};
...
class Calculator_divisionRequestUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_divisionRequest& instance, /*in*/ CORBA::Long x, /*in*/ CORBA::Long y);
         ...
         */
        static void extractTypeData(Calculator_divisionRequest& data, /*in*/ CORBA::Long& x, /*in*/ CORBA::Long& y);
};
...
class Calculator_divisionReplyUtils
{
    public:
         ...
         */
        static void setTypeData(Calculator_divisionReply& instance, /*out*/ CORBA::Long division_ret);
...
* \param retcode Internal message returned from the server.
         */
        static void extractTypeData(Calculator_divisionReply& data, eProsima::RPCDDS::ReturnMessage& retcode, /*out*/ CORBA::Long& division_ret);
};
