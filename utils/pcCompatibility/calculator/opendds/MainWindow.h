...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
            ...
            this->txtBox->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(192)), 
            ...
            this->openddsButton->Checked = true;
            ...
            // statusStrip
            // 
            this->statusStrip->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(136)), static_cast<System::Int32>(static_cast<System::Byte>(206)), 
            ...
            this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(136)), static_cast<System::Int32>(static_cast<System::Byte>(206)), 
                static_cast<System::Int32>(static_cast<System::Byte>(40)));
...
private: 
    ...
    System::Void bRes_Click(System::Object^  sender, System::EventArgs^  e)
    {
        if(operation != 0 && secondOpPosition != this->txtBox->Text->Length)
        {
            ...
            this->Text = L"Calculator (OpenDDS) ... Sending";

            if(operation == 1)
            {
                try
                {
                    CORBA::Long addition_ret = proxy->addition(firstOp, secondOp);
            ...
            else if(operation == 2)
            {
                try
                {
                    CORBA::Long substraction_ret = proxy->substraction(firstOp, secondOp);
            ...
            else if(operation == 3)
            {
                try
                {
                    CORBA::Long multiplication_ret = proxy->multiplication(firstOp, secondOp);
            ...
            else if(operation == 4)
            {
                try
                {
                    CORBA::Long division_ret = proxy->division(firstOp, secondOp);
