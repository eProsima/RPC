...
class CalculatorProxy : public eProsima::RPCDDS::Client
{
    public:
        ...
        void substraction_async(Calculator_substractionCallbackHandler &obj, /*in*/ DDS_Long x, /*in*/ DDS_Long y);
         
        void multiplication_async(Calculator_multiplicationCallbackHandler &obj, /*in*/ DDS_Long x, /*in*/ DDS_Long y);
         
        void division_async(Calculator_divisionCallbackHandler &obj, /*in*/ DDS_Long x, /*in*/ DDS_Long y);
