...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "eProsima\FastRPC"
...
!include EnvVarPage_fastrpc.nsh
...
!insertmacro MUI_PAGE_LICENSE ..\..\..\..\doc\licencias\FASTRPC_LICENSE.txt
...
!define MUI_FINISHPAGE_TEXT "eProsima FastRPC has been installed on your computer.$\n$\nClick Finish to close this wizard."
...
OutFile eProsima_FastRPC-${VERSION}-Windows.exe
InstallDir "$PROGRAMFILES\eProsima\fastrpc"
CRCCheck on
XPStyle on
...
Section -post SEC0006
    ...
    SetOverwrite on
    File "..\..\..\..\doc\FastRPC - Installation Manual.pdf"
    File "..\..\..\..\doc\FastRPC - User Manual.pdf"
    # Copy doxygen documentation
    File "/oname=FastRPC - API C++ Manual.pdf" "..\..\..\..\output\doxygen\latex\refman.pdf"
    ...
    SetOutPath $INSTDIR
    SetOverwrite on
    File /r ..\..\..\..\doc\licencias\FASTRPC_LICENSE.txt
    ...
    ${If} $CheckboxFASTRPCHOME_State == ${BST_CHECKED}
       ${EnvVarUpdate} $0 "FASTRPCHOME" "P" "HKLM" "$INSTDIR"
...
Section -un.post UNSEC0006
    ...
    ${un.EnvVarUpdate} $0 "FASTRPCHOME" "R" "HKLM" "$INSTDIR"
...
Function .onInit
    ...
    ${If} ${RunningX64}
       StrCpy '$INSTDIR' '$PROGRAMFILES64\eProsima\fastrpc'
    ${else}
       StrCpy '$INSTDIR' '$PROGRAMFILES\eProsima\fastrpc'
    ${EndIf}
    InitPluginsDir
	Push $R1
