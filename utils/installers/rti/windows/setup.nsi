...
OutFile eProsima_FastRPC_${VERSION}.exe
InstallDir "$PROGRAMFILES\eProsima\FastRPC"
CRCCheck on
XPStyle on
ShowInstDetails show
VIProductVersion ${VERSION}.0
VIAddVersionKey ProductName FastRPC
...
Function .onInit
    ...
    StrCmp $0 "" 0 +3
    StrCpy $RICHI_FINISH_MESSAGE "eProsima FastRPC has been installed on your computer.$\n$\nNote: NDDSHOME environment variable is not set in your system. eProsima FastRPC uses this environment variable to find the RTI DDS middleware. See the User Manual document.$\n$\nClick Finish to close this wizard."
    goto +3
    strcpy $INSTDIR $0\FastRPC
    Strcpy $RICHI_FINISH_MESSAGE "eProsima FastRPC has been installed on your computer.$\n$\nClick Finish to close this wizard."
    InitPluginsDir
	Push $R1
