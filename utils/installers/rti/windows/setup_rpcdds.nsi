...
Section -post SEC0006
    ...
    SetOverwrite on
    File "..\..\..\..\doc\RPCDDS - Installation Manual.pdf"
    File "..\..\..\..\doc\RPCDDS - User Manual.pdf"
    # Copy doxygen documentation
    File "/oname=RPCDDS - API C++ Manual.pdf" "..\..\..\..\output\doxygen\latex\refman.pdf"
    ...
    SetOutPath $INSTDIR
    SetOverwrite on
    File /r ..\..\..\..\doc\licencias\RPCDDS_LICENSE.txt
...
Function .onInit
    ...
    ${else}
       StrCpy '$INSTDIR' '$PROGRAMFILES\eProsima\rpcdds'
    ${EndIf}
    ReadEnvStr $0 NDDSHOME
    StrCmp $0 "" 0 +3
    StrCpy $RICHI_FINISH_MESSAGE "eProsima RPCDDS has been installed on your computer.$\n$\nNote: NDDSHOME environment variable is not set in your system. eProsima RPCDDS uses this environment variable to find the RTI DDS middleware. See the User Manual document.$\n$\nClick Finish to close this wizard."
    goto +3
...
!insertmacro MUI_DESCRIPTION_TEXT ${SECGRP0000} "eProsima RPCDDS libraries."
