eProsima FastRPC installation requires the following steps:
...
2. eProsima FastRPC also requires Boost libraries. Install them using your
Linux distribution package manager.

3. Install the eProsima FastRPC software.

    For 32-bit machines
    $ cd fastrpc; ./configure --libdir=/usr/lib; make; make install

    For 64-bit machines
    $ cd fastrpc; ./configure --libdir=/usr/lib64; make; make install

For more information read the Installation manual located in
"fastrpc/doc/pdf/FastRPC - Installation Manual.pdf"
