...
const char* getSLongRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getSLongRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    largoPluginSupport_copy_data(&l1, &data->l1);
...
const char* getSLongReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getSLongReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    cadenaPluginSupport_copy_data(&s1, &data->s1);
...
{
    dattosPluginSupport_copy_data(&sb1, &data->sb1);
