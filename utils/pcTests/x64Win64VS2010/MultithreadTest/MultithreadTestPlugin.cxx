...
DatoPluginSupport_create_data_ex(RTIBool allocate_pointers){
    ...
    if(sample != NULL) {
        if (!Dato_initialize_ex(sample,allocate_pointers)) {
...
{
    return DatoPluginSupport_create_data_ex(RTI_TRUE);
}
...
DatoPluginSupport_destroy_data_ex(
    ...
    Dato_finalize_ex(sample,deallocate_pointers);
...
DatoPluginSupport_destroy_data(
    ...
    DatoPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                DatoPlugin_get_serialized_sample_max_size, epd,
    ...
    const Dato *src)
{
    ...
    return DatoPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    return DatoPlugin_deserialize_sample( 
...
RTIBool DatoPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    Dato *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool DatoPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Dato **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
{
    if (drop_sample) {} /* To avoid warnings */
    return DatoPlugin_deserialize_key_sample(
...
struct PRESTypePlugin *DatoPlugin_new(void) 
{ 
    ...
    plugin->createSampleFnc =
        ...
        DatoPlugin_create_sample;
    plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        DatoPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
        ...
        DatoPlugin_get_sample;
    plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        DatoPlugin_return_sample;

    plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        DatoPlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode =  (struct RTICdrTypeCode *)Dato_get_typecode();
    ...
    plugin->getBuffer = 
        ...
        DatoPlugin_get_buffer;
    plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        DatoPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        DatoPlugin_get_serialized_sample_size;

    plugin->endpointTypeName = DatoTYPENAME;

    return plugin;
}

void
DatoPlugin_delete(struct PRESTypePlugin *plugin)
{
