...
const char* duplicateRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(duplicateRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    EnvioPluginSupport_copy_data(&ev, &data->ev);
    
    
}


const char* duplicateReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(duplicateReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
const char* sumaRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(sumaRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    EnvioPluginSupport_copy_data(&ev1, &data->ev1);
    EnvioPluginSupport_copy_data(&ev2, &data->ev2);
    
    
}


const char* sumaReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(sumaReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
