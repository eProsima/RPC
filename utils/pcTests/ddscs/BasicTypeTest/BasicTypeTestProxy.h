...
class BasicTypeTestProxy : public DDSCSClient
{
    public:
    ...
    private:
        ClientRemoteService *getOctet_Service;
        ClientRemoteService *getChar_Service;
        ClientRemoteService *getWChar_Service;
        ClientRemoteService *getShort_Service;
        ClientRemoteService *getUShort_Service;
        ClientRemoteService *getLong_Service;
        ClientRemoteService *getULong_Service;
        ClientRemoteService *getLLong_Service;
        ClientRemoteService *getULLong_Service;
        ClientRemoteService *getFloat_Service;
        ClientRemoteService *getDouble_Service;
        ClientRemoteService *getBoolean_Service; 
