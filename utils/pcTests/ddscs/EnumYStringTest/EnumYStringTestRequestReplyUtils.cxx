...
const char* getEnumRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getEnumRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
const char* getEnumReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getEnumReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
const char* getStringRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getStringRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    s1 = DDS_String_dup(data->s1);
    s2 = DDS_String_dup(data->s2);
    
    
}


const char* getStringReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getStringReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    s2 = DDS_String_dup(data->s2);
    s3 = DDS_String_dup(data->s3);
    
    returnedValue = DDS_String_dup(data->returnedValue);            
}


const char* getStringBoundedRequestUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getStringBoundedRequestTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
...
{
    sb1 = DDS_String_dup(data->sb1);
    sb2 = DDS_String_dup(data->sb2);
    
    
}


const char* getStringBoundedReplyUtils::registerType(DDSDomainParticipant *clientParticipant)
{
    const char *typeName = NULL;
    ...
    if(clientParticipant != NULL)
    {
        ...
        if(getStringBoundedReplyTypeSupport::register_type(clientParticipant, typeName) != DDS_RETCODE_OK)
        {
            return NULL;
        }
    }
