...
call ..\..\..\scripts\rpcddsgen.bat -local -d output\util -example %NDDSTARGET% -topicGeneration byOperation "IncludesTest\util\Util.idl"
set errorstatus=%ERRORLEVEL%
if not %errorstatus%==0 goto :EOF
call ..\..\..\scripts\rpcddsgen.bat -local -d output -example %NDDSTARGET% -topicGeneration byOperation -IIncludesTest -IIncludesTest\hide "IncludesTest\IncludesTest.idl" "IncludesTest\SameDirectory.idl" "IncludesTest\Level2.idl" "IncludesTest\hide\Hide.idl"
set errorstatus=%ERRORLEVEL%
...
mkdir output\util
:: Generates the rest of files with FASTRPC script
call ..\..\..\scripts\rpcddsgen.bat -local -d output\util -example %NDDSTARGET% -topicGeneration byInterface "IncludesTest\util\Util.idl"
set errorstatus=%ERRORLEVEL%
if not %errorstatus%==0 goto :EOF
call ..\..\..\scripts\rpcddsgen.bat -local -d output -example %NDDSTARGET% -topicGeneration byInterface -IIncludesTest -IIncludesTest\hide "IncludesTest\IncludesTest.idl" "IncludesTest\SameDirectory.idl" "IncludesTest\Level2.idl" "IncludesTest\hide\Hide.idl"
set errorstatus=%ERRORLEVEL%
:: Copy backup to original files.
:: Copy static test files into output directory
copy IncludesTest\* output\
