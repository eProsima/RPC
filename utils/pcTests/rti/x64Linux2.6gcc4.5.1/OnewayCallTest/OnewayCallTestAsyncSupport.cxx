...
void OnewayCallTest_getLongTask::on_exception(const eProsima::RPCDDS::SystemException &ex)
{
...
void OnewayCallTest_getBooleanTask::on_exception(const eProsima::RPCDDS::SystemException &ex)
{
    getObject().on_exception(ex);
}
...
void OnewayCallTest_getStringTask::on_exception(const eProsima::RPCDDS::SystemException &ex)
{
    getObject().on_exception(ex);
}
...
void OnewayCallTest_getStructTask::on_exception(const eProsima::RPCDDS::SystemException &ex)
{
    getObject().on_exception(ex);
}
