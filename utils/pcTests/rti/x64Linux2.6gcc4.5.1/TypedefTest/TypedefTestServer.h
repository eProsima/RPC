 ...
 *************************************************************************
 * 
 * @file TypedefTestServer.h
 * This header file contains the declaration of the server for interface TypedefTest.
 *
 ...
 */
class TypedefTestServer : public eProsima::RPCDDS::Server
{
    public:
         ...
         */
        TypedefTestServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \exception eProsima::RPCDDS::InitializeException This exception is thrown when the initialization was wrong.
         */
        TypedefTestServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy, eProsima::RPCDDS::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~TypedefTestServer();

        static void getLargo(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void getLarguisimo(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void getDatosDef(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void getDatosDefondo(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void getCadena(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void getCorrea(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
