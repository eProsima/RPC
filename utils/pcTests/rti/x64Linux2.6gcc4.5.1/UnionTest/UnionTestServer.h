...
class UnionTestServer : public eProsima::DDSRPC::Server
{
    public:
         ...
         */
        UnionTestServer(std::string serviceName, eProsima::DDSRPC::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \exception eProsima::DDSRPC::InitializeException This exception is thrown when the initialization was wrong.
         */
        UnionTestServer(std::string serviceName, eProsima::DDSRPC::ServerStrategy *strategy, eProsima::DDSRPC::Transport *transport,
            int domainId = 0);
