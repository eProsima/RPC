...
ValoresPlugin_serialize(
    PRESTypePluginEndpointData endpoint_data,
    const Valores *sample, struct RTICdrStream *stream,
...
ValoresPlugin_get_serialized_sample_max_size(
    PRESTypePluginEndpointData endpoint_data,
...
NDDSUSERDllExport extern unsigned int
ValoresPlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
NDDSUSERDllExport extern RTIBool 
ValoresPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    Valores *sample,
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
NDDSUSERDllExport extern unsigned int 
ValoresPlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment);
...
ValoresPluginSupport_print_data(
    const Valores *sample, const char *desc, int indent_level);
