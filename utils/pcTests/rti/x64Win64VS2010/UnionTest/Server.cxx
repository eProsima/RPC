 ...
 * 
 * @file Server.cxx
 * This source file shows a simple example of how to create a server for interface UnionTest.
 *
...
int main(int argc, char **argv)
{
    ...
    UnionTestServer *server = NULL;
    
    // Create and initialize the server for interface "UnionTest".
    try
    {
        pool = new eProsima::RPCDDS::ThreadPoolStrategy(threadPoolSize);
        server = new UnionTestServer("UnionTestService", pool);
        server->serve();
    }
