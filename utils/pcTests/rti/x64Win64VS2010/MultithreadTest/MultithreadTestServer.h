 ...
 */
class MultithreadTestServerH : public eProsima::DDSRPC::Server
{
    private: 
      MultithreadTestServerImpl *_impl;
    public:
         ...
         */
        MultithreadTestServerH(eProsima::DDSRPC::ServerStrategy *strategy, eProsima::DDSRPC::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~MultithreadTestServerH();
 ...
 */
class MultithreadTestServer : public MultithreadTestServerH
{
    public:
         ...
         * \param domainId The DDS domain that DDS will use to work. Default value: 0
         */
        MultithreadTestServer(eProsima::DDSRPC::ServerStrategy *strategy,
            int domainId = 0);
 ...
 */
class MultithreadTestWANServer : public MultithreadTestServerH
{
    public:
         ...
         * \param domainId The DDS domain that DDS will use to work. Default value: 0
         */
        MultithreadTestWANServer(eProsima::DDSRPC::ServerStrategy *strategy, 
            const char *public_address, const char *server_bind_port,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~MultithreadTestWANServer();
};
