 ...
 * 
 * @file Server.cxx
 * This source file shows a simple example of how to create a server for interface TypedefTest.
 *
...
int main(int argc, char **argv)
{
    ...
    TypedefTestServer *server = NULL;
    
    // Create and initialize the server for interface "TypedefTest".
    try
    {
        pool = new eProsima::RPCDDS::ThreadPoolStrategy(threadPoolSize);
        server = new TypedefTestServer("TypedefTestService", pool);
        server->serve();
    }
