 ...
 */
class StructTestServerH : public eProsima::DDSRPC::Server
{
    private: 
      StructTestServerImpl *_impl;
    public:
         ...
         */
        StructTestServerH(eProsima::DDSRPC::ServerStrategy *strategy, eProsima::DDSRPC::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~StructTestServerH();
 ...
 */
class StructTestServer : public StructTestServerH
{
    public:
         ...
         * \param domainId The DDS domain that DDS will use to work. Default value: 0
         */
        StructTestServer(eProsima::DDSRPC::ServerStrategy *strategy,
            int domainId = 0);
 ...
 */
class StructTestWANServer : public StructTestServerH
{
    public:
         ...
         * \param domainId The DDS domain that DDS will use to work. Default value: 0
         */
        StructTestWANServer(eProsima::DDSRPC::ServerStrategy *strategy, 
            const char *public_address, const char *server_bind_port,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~StructTestWANServer();
};
