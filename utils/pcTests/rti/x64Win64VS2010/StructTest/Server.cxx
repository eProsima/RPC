 ...
 * 
 * @file Server.cxx
 * This source file shows a simple example of how to create a server for interface StructTest.
 *
...
int main(int argc, char **argv)
{
    ...
    StructTestServer *server = NULL;
    
    // Create and initialize the server for interface "StructTest".
    try
    {
        pool = new eProsima::RPCDDS::ThreadPoolStrategy(threadPoolSize);
        server = new StructTestServer("StructTestService", pool);
        server->serve();
    }
