...
call ..\..\..\scripts\fastrpc_rti_pcTests.bat -d output\util -example %NDDSTARGET% -protocol dds "IncludesTest\util\Util.idl"
set errorstatus=%ERRORLEVEL%
if not %errorstatus%==0 goto :EOF
call ..\..\..\scripts\fastrpc_rti_pcTests.bat -d output -example %NDDSTARGET% -protocol dds -IIncludesTest -IIncludesTest\hide "IncludesTest\IncludesTest.idl" "IncludesTest\SameDirectory.idl" "IncludesTest\Level2.idl" "IncludesTest\hide\Hide.idl"
set errorstatus=%ERRORLEVEL%
