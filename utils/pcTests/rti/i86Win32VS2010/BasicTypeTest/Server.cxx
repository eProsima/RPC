 ...
 * 
 * @file Server.cxx
 * This source file shows a simple example of how to create a server for interface BasicTypeTest.
 *
...
int main(int argc, char **argv)
{
    ...
    BasicTypeTestServer *server = NULL;
    
    // Create and initialize the server for interface "BasicTypeTest".
    try
    {
        pool = new eProsima::RPCDDS::ThreadPoolStrategy(threadPoolSize);
        server = new BasicTypeTestServer("BasicTypeTestService", pool);
        server->serve();
    }
