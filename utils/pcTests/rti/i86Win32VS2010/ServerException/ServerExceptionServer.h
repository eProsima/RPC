 ...
 *************************************************************************
 * 
 * @file ServerExceptionServer.h
 * This header file contains the declaration of the server for interface ServerException.
 *
 ...
 */
class ServerExceptionServer : public eProsima::RPCDDS::Server
{
    public:
         ...
         */
        ServerExceptionServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \exception eProsima::RPCDDS::InitializeException This exception is thrown when the initialization was wrong.
         */
        ServerExceptionServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy, eProsima::RPCDDS::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~ServerExceptionServer();

        static void sendException(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void sendExceptionTwo(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
        static void sendExceptionThree(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
