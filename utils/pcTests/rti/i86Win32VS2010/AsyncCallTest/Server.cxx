 ...
 * 
 * @file Server.cxx
 * This source file shows a simple example of how to create a server for interface AsyncCallTest.
 *
...
int main(int argc, char **argv)
{
    ...
    AsyncCallTestServer *server = NULL;
    
    // Create and initialize the server for interface "AsyncCallTest".
    try
    {
        pool = new eProsima::RPCDDS::ThreadPoolStrategy(threadPoolSize);
        server = new AsyncCallTestServer("AsyncCallTestService", pool);
        server->serve();
    }
