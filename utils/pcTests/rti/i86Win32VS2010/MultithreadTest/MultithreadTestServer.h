 ...
 *************************************************************************
 * 
 * @file MultithreadTestServer.h
 * This header file contains the declaration of the server for interface MultithreadTest.
 *
 ...
 */
class MultithreadTestServer : public eProsima::RPCDDS::Server
{
    public:
         ...
         */
        MultithreadTestServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy,
            int domainId = 0);
         ...
         * \exception eProsima::RPCDDS::InitializeException This exception is thrown when the initialization was wrong.
         */
        MultithreadTestServer(std::string serviceName, eProsima::RPCDDS::ServerStrategy *strategy, eProsima::RPCDDS::Transport *transport,
            int domainId = 0);

        /// \brief The default destructor.
        virtual ~MultithreadTestServer();

        static void test(eProsima::RPCDDS::Server *server, void *requestData, eProsima::RPCDDS::ServerRPC *service);
