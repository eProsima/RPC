			...
			*/
            ...
            private boost::noncopyable
            {
                ...
                public:
					 ...
					 * @return Read buffer used number of bytes
					 */
                    inline
					 ...
					 * @param numData Number of used bytes to add to the total used bytes
					 */
                    inline
					...
					/*!
					 * @brief This method gets the length of the read buffer
					...
					/*!
					 * @brief This method moves the not yet read bytes of the read buffer to the beginning of the buffer
					 */
					...
					/*!
					 * @brief This method tells if the connection with the endpoint is open or closed
					 * @return bool if the connection is open, false if it is closed
					 */
                    bool isOpen();
