...
public:
    ...
    createProcedureEndpoint(
            ...
            bool eprosima_types,
            Transport::Create_data create_data,
            Transport::Copy_data copy_data,
            Transport::Destroy_data destroy_data,
            Transport::ProcessFunc processFunc,
            int dataSize);
     ...
     */
    RPC_DllAPI int addAsyncTask(
            DDSQueryCondition* query,
            DDSAsyncTask* task,
            long timeout);
     ...
     */
    RPC_DllAPI void deleteAssociatedAsyncTasks(
...
protected:
     ...
     */
    virtual RPC_DllAPI int setTransport(
     ...
     */
    RPC_DllAPI ProxyTransport(
            const char* const remoteServiceName = NULL,
