            ...
            namespace rest
            {
                ...
                class RESTSerializer
                {
                    private:
                        ...
                        FASTRPC_DllAPI RESTSerializer& serialize(const char* const &string_t);

                        FASTRPC_DllAPI const char* readString(uint32_t &length);
                    ...
                    public:
						 ...
						 */
                        inline
                        FASTRPC_DllAPI RESTSerializer& deserialize(std::string &string_t)
                        {
                            uint32_t length = 0;
						 ...
						 * @return Reference to the RESTSerializer object
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPMethod &method);
						 ...
						 * @return Reference to the RESTSerializer object
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPMethod &method);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPUri &uri);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPUri &uri);
						 ...
						 * @return Reference to the RESTSerializer object
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPVersion &version);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPVersion &version);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPData &data);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPData &data);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPResponseCode &responseCode);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPResponseCode &responseCode);
						 ...
						 * @return Reference to the RESTSerializer object
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPParam &param);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPParam &param);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPParameters &params);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPParameters &params);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serialize(HTTPParameters &params, size_t numElements); 
						/*!
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserialize(HTTPParameters &params, size_t numElements);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serializeQueryParameter(std::string &uri, const std::string &paramName,
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& beginSerializeTemplateParameters(std::string &&uri);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& serializeTemplateParameter(const std::string &paramValue);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& endSerializeTemplateParameters(std::string &uri);
						 ...
						 * @return Reference to the RESTSerializer object.
						 */
                        FASTRPC_DllAPI RESTSerializer& deserializeUri(const std::string &uri, const std::string baseUri);
