...
public class RPCDDSGEN
{
    ...
    public boolean execute()
    {
        ...
        try
        {
        	...
        	ddsGen(messageHeaderFileLocation, m_lineCommand, m_lineCommandForWorkDirSet, true, false);
        	// Create a project for MessageHeader.idl
        	Project project = new Project("MessageHeader", messageHeaderFileLocation, new HashSet());
    ...
    private Project process(String idlFilename)
    {
        ...
        if(ddsGenInit(idlFilename, idlLineCommand, idlLineCommandForWorkDirSet))
        {
            try
            {
                // First step is to parse the user IDL file.
                ...
                if((project = parseIDL(idlFilename)) != null)
                {
                	if(!project.getUnique())
                	{
                		...
                		ddsGen(onlyFileName + "RequestReply.idl", idlLineCommand, idlLineCommandForWorkDirSet,
        ...
        if(idlParseFileName != null)
        {
	        ...
	        if(returnedValue)
	        {
		        ...
		        if(ifc != null)
		        {
		        	...
		        	ctx.addDependency(messageHeaderFileLocation);
		        }
    ...
    String callPreprocessor(String idlFilename)
    {
        ...
        // Use temp directory.
        if(m_tempDir != null)
        	outputfile = m_tempDir + File.separator + outputfile;
