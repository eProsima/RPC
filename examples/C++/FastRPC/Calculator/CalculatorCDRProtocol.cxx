 ...
 *************************************************************************
 * 
 * @file CalculatorCDRProtocol.cxx
...
CalculatorProtocol::CalculatorProtocol() : ::protocol::CalculatorProtocol(),
        ...
        if(((int32_t*&)buffer)[0] == 0x46434452)
        {
            ...
            if(code == 0)
            {
                ...
                dcdr.deserialize(operation_name);
                    ...
                    if(interface_name.compare("Calculator") == 0)
                    {
                        if(_protocol._Calculator_impl != NULL)
                        {
                                if(operation_name.compare("addition") == 0)
                                {
                                    int32_t  value1 = 0;
                                    int32_t  value2 = 0;
...
{
    const char* const interface_name = "Calculator";
    const char* const operation_name = "addition";
...
{
    const char* const interface_name = "Calculator";
    const char* const operation_name = "subtraction";
    // TODO In DDS the initialization is not necessary. But in CDR it is, for example a union with a char* (string) needs to be initialized to NULL.
    int32_t  subtraction_ret = 0;
