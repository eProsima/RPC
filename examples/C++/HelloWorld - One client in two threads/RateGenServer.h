...
class RateGenServer : public DDSCSServer
{
    ...
    public:
        ...
        static void subscribe_Pulse(DDSCSServer *server, void *requestData, ServerRemoteService *service);
        static void unsubscribe_Pulse(DDSCSServer *server, void *requestData, ServerRemoteService *service);
        static void noReturnFunction(DDSCSServer *server, void *requestData, ServerRemoteService *service);
};
