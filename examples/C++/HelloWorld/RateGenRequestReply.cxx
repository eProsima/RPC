...
DDS_TypeCode* sumaRequest_get_typecode()
{
    ...
    static DDS_TypeCode sumaRequest_g_tc_clientId_array = DDS_INITIALIZE_ARRAY_TYPECODE(1,3,NULL,NULL);

    static DDS_TypeCode_Member sumaRequest_g_tc_members[5]=
    {
        {
    ...
    sumaRequest_g_tc_clientId_array._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulong;

    sumaRequest_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&sumaRequest_g_tc_clientId_array;
    ...
    sumaRequest_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
...
DDS_TypeCode* sumaReply_get_typecode()
{
    ...
    static DDS_TypeCode sumaReply_g_tc_clientId_array = DDS_INITIALIZE_ARRAY_TYPECODE(1,3,NULL,NULL);
    ...
    sumaReply_g_tc_clientId_array._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulong;

    sumaReply_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&sumaReply_g_tc_clientId_array;
    sumaReply_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_ulong;
    sumaReply_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
