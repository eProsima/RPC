...
/**
 * \brief This class implements a specific server's proxy for the defined interface HelloWorldAsync.
 */
class HelloWorldAsyncProxy : public eProsima::RPCDDS::Client
{
    public:
         ...
         * \exception eProsima::RPCDDS::InitializeException This exception is thrown when the initialization was wrong.
         */
        HelloWorldAsyncProxy(std::string remoteServiceName, eProsima::RPCDDS::Transport *transport, int domainId = 0, long timeout = 10000);
    ...
    private:
        ...
        eProsima::RPCDDS::ClientRPC *sayHello_Service; 
};
