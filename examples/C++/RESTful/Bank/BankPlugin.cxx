...
account_accountNumberPluginSupport_create_data_ex(RTIBool allocate_pointers){
    account_accountNumber *sample = NULL;
    ...
    unsigned int indent_level)
{
    ...
    RTICdrType_printLong(
        &sample->accountNumber_, "accountNumber_", indent_level + 1);
...
RTIBool account_accountNumberPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
...
RTIBool account_accountNumberPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    account_accountNumber *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool account_accountNumberPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    account_accountNumber **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
/* --------------------------------------------------------------------------------------
 *  Type XMLGetAccountDetailsResponse
 * -------------------------------------------------------------------------------------- */
...
XMLGetAccountDetailsResponsePluginSupport_create_data_ex(RTIBool allocate_pointers){
    XMLGetAccountDetailsResponse *sample = NULL;
...
RTIBool XMLGetAccountDetailsResponsePlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
...
RTIBool XMLGetAccountDetailsResponsePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    XMLGetAccountDetailsResponse *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool XMLGetAccountDetailsResponsePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    XMLGetAccountDetailsResponse **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
GetAccountDetailsResponsePluginSupport_create_data_ex(RTIBool allocate_pointers){
    GetAccountDetailsResponse *sample = NULL;
...
RTIBool GetAccountDetailsResponsePlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
...
RTIBool GetAccountDetailsResponsePlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    GetAccountDetailsResponse *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool GetAccountDetailsResponsePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    GetAccountDetailsResponse **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
GetAccountDetailsRequestPluginSupport_create_data_ex(RTIBool allocate_pointers){
    GetAccountDetailsRequest *sample = NULL;
    ...
    unsigned int indent_level)
{
    ...
    if (&sample->_u.xmlRepresentation==NULL) {
        RTICdrType_printString(
            NULL, "_u.xmlRepresentation", indent_level + 1);                
    } else {
        RTICdrType_printString(
            sample->_u.xmlRepresentation, "_u.xmlRepresentation", indent_level + 1);                
    }
    ...
    void *endpoint_plugin_qos)
{
    ...
    if (!RTICdrStream_serializeString(
        stream, sample->_u.xmlRepresentation, (255) + 1)) {
        return RTI_FALSE;
    }
...
RTIBool GetAccountDetailsRequestPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    const GetAccountDetailsRequest * sample) 
{
    ...
    current_alignment += RTICdrType_getStringSerializedSize(
        current_alignment, sample->_u.xmlRepresentation);
...
RTIBool GetAccountDetailsRequestPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    GetAccountDetailsRequest *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool GetAccountDetailsRequestPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    GetAccountDetailsRequest **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
