 ...
 */
class RPCDDSUSERDllExport CalculatorServer : public eprosima::rpcdds::server::Server
{
    public:
         ...
         */
        CalculatorServer(eprosima::rpcdds::strategy::ServerStrategy &strategy, eprosima::rpcdds::transport::ServerTransport &transport,
