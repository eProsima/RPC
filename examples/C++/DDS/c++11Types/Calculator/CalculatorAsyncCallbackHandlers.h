...
class Calculator_additionCallbackHandler
{
    public:
         ...
         */
        virtual void addition(/*out*/ int32_t addition_ret) = 0;
         ...
         */
        virtual void on_exception(const eprosima::fastrpc::exception::SystemException &ex) = 0;
};
...
class Calculator_subtractionCallbackHandler
{
    public:
         ...
         * This function is called when is received the reply from the server.
         */
        virtual void subtraction(/*out*/ int32_t subtraction_ret) = 0;
