 ...
 * @ingroup CALCULATOR
 */
class Calculator_additionTask : public eprosima::fastrpc::transport::dds::DDSAsyncTask
{
    public:
 ...
 * @ingroup CALCULATOR
 */
class Calculator_subtractionTask : public eprosima::fastrpc::transport::dds::DDSAsyncTask
{
    public:
