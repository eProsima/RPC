    ...
    void *endpoint_plugin_qos)
{
    ...
    if(serialize_sample)
    {
        ...
        catch(eprosima::fastrpc::exception::BadParamException ex)
        {
            //printf("ERROR<eprosima::fastrpc::exception::BadParamException>: %s\n", ex.what());
            return RTI_FALSE;
        }
...
DDS_TypeCode* CalculatorRequestPlugin::get_typecode()
{
    ...
    if(!is_initialized)
    {
        CalculatorRequest_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)eprosima::fastrpc::protocol::dds::RequestHeaderPlugin::get_typecode();
...
DDS_TypeCode* CalculatorReplyPlugin::get_typecode()
{
    ...
    if(!is_initialized)
    {
        CalculatorReply_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)eprosima::fastrpc::protocol::dds::ReplyHeaderPlugin::get_typecode();
