 ...
 * @ingroup CALCULATOR
 */
class FASTRPCUSERDllExport CalculatorServer : public eprosima::fastrpc::server::Server
{
    public:
         ...
         */
        CalculatorServer(eprosima::fastrpc::strategy::ServerStrategy &strategy, eprosima::fastrpc::transport::ServerTransport &transport,
