...
int main(int argc, char **argv)
{
	if(argc == 3)
	{
		...
		if(sscanf(argv[1], "%d", &value1) == 1)
		{
			...
			{
				eProsima::RPCDDS::TCPClientTransport *transport = NULL;
				CalculatorProxy *proxy = NULL;
    
				// Creation of the proxy for interface "Calculator".
				try
				{
					transport = new eProsima::RPCDDS::TCPClientTransport("80.32.132.11:7600");
					proxy = new CalculatorProxy("CalculatorService", transport);
				}
