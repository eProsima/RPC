...
if(NOT "${_NDDSHOME}" STREQUAL "")
    ...
    if(NOT "${RTIDDS_FIND_VERSION}" STREQUAL "")
        string(FIND "${_NDDSHOME}" "ndds.${RTIDDS_FIND_VERSION}" _found)
        if(${_found} EQUAL -1)
    ...
    if(${_goodversion})
        if(NOT "${RTIDDS_FIND_VERSION}" STREQUAL "")
            message(STATUS "Found RTI DDS ${RTIDDS_FIND_VERSION}: ${_NDDSHOME}")
        else()
        ...
        _find_rtidds_ensure_libraries(_found_all_libraries "${_expected_library_names}" "${_libs}")
        ...
        if(WIN32)
            set(RTIDDS_DEFINITIONS "RTI_WIN32" "NDDS_DLL_VARIABLE")
        else()
    ...
    if(nddscpp_FOUND)
        ...
        _find_rtidds_ensure_libraries(_found_all_libraries "${_expected_library_names}" "${RTIDDS_LIBRARIES}")
        if(NOT _found_all_libraries)
